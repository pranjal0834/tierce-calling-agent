      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        ...
        <div className="relative sm:shrink-0">
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-1.5 text-xs px-3 py-2 sm:py-1.5 bg-white hover:bg-neutral-50 text-neutral-600 border border-neutral-300 rounded-lg transition-colors"
          >
            <Plus className="w-3 h-3" />
            Verify another country
          </button>
          {showAddPicker && (
            <div className="absolute left-0 right-0 sm:left-auto sm:right-0 top-full mt-1 z-20 w-auto sm:w-64 bg-white border border-neutral-200 rounded-xl shadow-xl overflow-hidden">
              ...
              <div className="flex items-center shrink-0">
                {status === "approved" ? (
                  ...
                  <button
                    ...
                    className="text-xs px-3 py-1.5 bg-brand-500 hover:bg-brand-600 text-white rounded-lg transition-colors font-medium whitespace-nowrap"
                  >
        ...
        <div className="bg-white border border-neutral-200 shadow-sm rounded-2xl p-4 mb-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-stretch gap-2">
            {[
              ...
              <div key={step.n} className="flex flex-col sm:flex-1 sm:flex-row sm:items-stretch">
                <div className={`flex-1 rounded-xl px-3 py-2.5 border ${step.color} flex items-center sm:flex-col sm:items-start gap-2.5 sm:gap-1`}>
                  <span className={`w-5 h-5 rounded-full ${step.badge} text-[10px] font-bold flex items-center justify-center shrink-0`}>
                    {step.n}
                  </span>
