...
export function InputField({ label, registration, error, required, type = "text", placeholder, hint, rows }: InputFieldProps) {
...
export function SelectField({ label, registration, error, required, placeholder, options }: SelectFieldProps) {
  ...
  return (
    <FormField label={label} error={error} required={required}>
      <select {...registration} className={`${base} ${border}`}>
