  ...
  return (
    <div className="bg-white border border-neutral-200 rounded-2xl p-5 shadow-card">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-8 h-8 bg-brand-50 border border-brand-200 rounded-lg flex items-center justify-center shrink-0">
          ...
          <button
            ...
            className={`flex-1 py-2.5 px-4 rounded-xl text-sm font-medium border transition-all duration-150 ${
              local.provider === p
                ...
                : "bg-white border-neutral-200 text-neutral-600 hover:text-neutral-900 hover:border-neutral-300 hover:bg-neutral-50"
            }`}
          >
      ...
      {local.provider === "twilio" ? (
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-xs space-y-1">
              <p className="text-blue-900 font-semibold">Using Twilio (global)</p>
              <p className="text-blue-700">Credentials are loaded from your environment variables (<code className="bg-blue-100 px-1 py-0.5 rounded font-mono">TWILIO_ACCOUNT_SID</code> / <code className="bg-blue-100 px-1 py-0.5 rounded font-mono">TWILIO_AUTH_TOKEN</code>).</p>
              <p className="text-blue-700">You can buy US, UK, CA, AU, DE, FR, SE and SG numbers directly from this page.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-xs space-y-1">
              <p className="text-emerald-900 font-semibold">Using Plivo (India)</p>
              <p className="text-emerald-700">Platform-managed account — no credentials needed. Best for Indian numbers (+91).</p>
              <p className="text-emerald-700">For US, UK, AU and other international numbers, switch to <span className="font-semibold">Twilio</span>.</p>
            </div>
          </div>
        </div>
      ) : (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-neutral-100 border border-neutral-200 text-neutral-900 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-brand-500 font-mono"
              />
            </div>
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-neutral-100 border border-neutral-200 text-neutral-900 rounded-xl px-3 py-2.5 pr-9 text-sm focus:outline-none focus:border-brand-500 font-mono"
                />
                <button
                  type="button"
      ...
      {isDirty && (
        <div className="mt-4 flex justify-end">
          <button
            onClick={save}
            disabled={saving}
            className="flex items-center gap-2 px-4 py-2 bg-brand-500 hover:bg-brand-600 disabled:opacity-50 text-white text-sm font-medium rounded-xl shadow-xs transition-colors"
          >
